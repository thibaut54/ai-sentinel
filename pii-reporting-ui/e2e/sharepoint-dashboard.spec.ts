...
/**
 * Consolidated E2E tests for the SharePoint Dashboard.
 * Covers table display, scan lifecycle, sorting, filtering, PII expansion, and reveal.
 */
test.describe('SharePoint Dashboard', () => {
  const testIds = TestIds.sharepoint;
  const dialogSelectors = DIALOG_SELECTORS.confirmDialog;

  test.beforeEach(async ({ page }) => {
    await navigateToDashboard(page, 'sharepoint');
  ...
  test.describe('Table Display', () => {
    test('should display table with site data', async ({ page }) => {
