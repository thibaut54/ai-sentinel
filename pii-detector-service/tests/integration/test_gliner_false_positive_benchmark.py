...
GLINER_LABELS: Dict[str, str] = {
    ...
    "DRIVER_LICENSE_NUMBER": "driver license identification",
    ...
    "BANK_ACCOUNT_NUMBER": "financial institution account number",
    "IBAN": "iban",
    "BIC_SWIFT": "swift code",
    "TAX_ID": "tax identifier",
    "SALARY": "salary amount",
    # MEDICAL
    "AVS_NUMBER": "Swiss AVS 13-digit personal number",
    "PATIENT_ID": "hospital patient identifier",
    "MEDICAL_RECORD_NUMBER": "medical file number",
    ...
    "HOSTNAME": "hostname",
    "DEVICE_ID": "mobile device unique identifier",
    "PASSWORD": "password",
    ...
    "LICENSE_NUMBER": "regulatory license identifier",
    "CRIMINAL_RECORD": "criminal background record",
    "VEHICLE_REGISTRATION": "vehicle registration plate number",
    "LICENSE_PLATE": "vehicle license plate",
    "VIN": "vehicle chassis identification number",
    "INSURANCE_POLICY_NUMBER": "insurance policy identifier",
}
